        ...
        <div className={style.projects__main}>
            <div className={style.projects__container}>
                ...
                <section className={style.single__project__container}>
                    ...
                    <a href="https://taraejohnson.github.io/Donut-Maker/" className={style.project__link}>See it deployed on Github</a><a href="https://github.com/taraejohnson/Donut-Maker" className={style.project__link}>or check out the code.</a>
                    </section>
            </div>
        </div>
    )
